...
- For some reason the scrolling on neovim seems to be really bad
- I would like native scrolling on `tmux` inside neovim
...
### Ghostty support on remote hosts

- How do I make sure the `terminfo` is correctly populated
