...
echo "==> Removing retired Vault Hunter tools"
rm -f \
    "$HOME/.local/bin/atlas" \
    "$HOME/.local/bin/vault-hunter-atlas" \
    "$HOME/.local/bin/vault-hunter-observe" \
    "$HOME/.local/bin/vault-hunter-registry" \
    "$HOME/.local/bin/vault-hunter-status"

echo "==> Removing retired Vault Hunter skills"
rm -f \
    "$HOME/.agents/skills/vault-hunter" \
    "$HOME/.agents/skills/vault-hunter-check" \
    "$HOME/.agents/skills/vault-hunter-checkpoint" \
    "$HOME/.agents/skills/vault-hunter-worker" \
    "$HOME/.agents/skills/vault-scout"
...
stow --no-folding --ignore='state\.json' -d "$DOTFILES_DIR" -t "$HOME" hunk
